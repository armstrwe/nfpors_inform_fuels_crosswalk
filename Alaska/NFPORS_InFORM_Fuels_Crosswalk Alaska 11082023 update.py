...
# US Veg Departure Percent (no Alaska)
...
# sys.exit()
# columns_to_print = ['Column1', 'Column2', 'Column3', 'Column4']
# selected_columns = df[columns_to_print]
# sys.exit()
...
output_folder = r'C:\Users\warmstrong\Documents\work\InFORM\20230912 NFPORS InFORM Crosswalk Script\data output\11072023 BIA Output'
